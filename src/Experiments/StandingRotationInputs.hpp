 ...
 *   to make the robot standing using a 2D substrate that takes
 ...
 *   the ground or not.
 */
class StandingRotationInputs : public Experiment {
public:
  StandingRotationInputs();
  ~StandingRotationInputs();

  void initPhenotype(Phenotype& p) const;
