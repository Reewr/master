...
WalkingSimpleInputs::~WalkingSimpleInputs() {
  delete mPopulation;
  delete mSubstrate;
}

void WalkingSimpleInputs::outputs(Phenotype&                 p,
...
std::vector<double> WalkingSimpleInputs::inputs(const Phenotype& p) const {
