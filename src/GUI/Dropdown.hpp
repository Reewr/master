...
public:
  ...
  bool isInsideOptionsList(const mmm::vec2& position) const;
  ...
  bool setActiveItem(const mmm::vec2& position);
  ...
  void setPosition(const mmm::vec2& position);
...
private:
  ...
  mmm::vec2 mActiveOptionPosition;
