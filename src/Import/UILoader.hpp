...
namespace Import {
  ...
  private:
    ...
    void getAttrib(tinyxml2::XMLElement* e, const char* a, const char* b, vec2& v);
    std::string getAttrib(tinyxml2::XMLElement* e, const char* a);

    void handleWindowElement(tinyxml2::XMLElement* winElement, Window* win, bool isOnlyWin = false);
    ...
    enum { FILEERROR, LOADSETTERROR, INVSCREEN, ATTRIBINTFAIL, ATTRIBFLOFAIL, ATTRIBSTRFAIL};
