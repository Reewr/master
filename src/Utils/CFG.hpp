...
private:
  ...
  std::map<Prop, Wrapper> map {
    {"Graphics.anisotropicfiltering", {graphics.aniso, {
      {"off", 1}, {"2x", 2}, {"4x", 4}, {"8x", 8}, {"16x", 16}
    }}},
    {"Graphics.antialiasing", {graphics.aliasing, {
      {"off", 1}, {"2x", 2}, {"4x", 4}, {"8x", 8}, {"16x", 16}
    }}},
    ...
    {"Graphics.shadow_samples", {graphics.shadowSamples, {
      {"off", 1}, {"2x", 2}, {"4x", 4}, {"8x", 8}, {"16x", 16}
    }}},
    {"Graphics.shadow_resolution", {graphics.shadowRes, {
      {"low", 512}, {"medium", 1024}, {"high", 2048}, {"ultra", 4096}
    }}},
    {"Graphics.view_distance", {graphics.viewDistance, {
      {"low", 20}, {"medium", 40}, {"high", 60}, {"ultra", 80}
    }}},
    {"Graphics.vsync", graphics.vsync},
    {"Graphics.windowmode", {graphics.winMode, {
      {"window", 0},
      {"borderless", 1},
      {"fullscreen", 2}
    }}},
  ...
  std::vector<Prop> duplicates {
    "Graphics.resolution.x",
