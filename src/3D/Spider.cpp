...
std::map<std::string, Spider::Part> Spider::SPIDER_PARTS =
  { { "Abdomin",
    ...
    { "TarsusL1",
      { 0b0010100000000000, 0b1101011111111111, radians(-20), false } },
    { "TarsusL2",
      { 0b0010010000000000, 0b1101101111111111, radians(-20), false } },
    { "TarsusL3",
      { 0b0010001000000000, 0b1101110111111111, radians(-20), false } },
    { "TarsusL4",
      { 0b0010000100000000, 0b1101111011111111, radians(-20), false } },
    { "TarsusR1",
      { 0b0001100000000000, 0b1110011111111111, radians(-20), false } },
    { "TarsusR2",
      { 0b0001010000000000, 0b1110101111111111, radians(-20), false } },
    { "TarsusR3",
      { 0b0001001000000000, 0b1110110111111111, radians(-20), false } },
    { "TarsusR4",
      { 0b0001000100000000, 0b1110111011111111, radians(-20), false } },
    { "TibiaL1",
      { 0b0010100000000000, 0b1101011111111111, radians(-45), true } },
    { "TibiaL2",
      { 0b0010010000000000, 0b1101101111111111, radians(-45), true } },
